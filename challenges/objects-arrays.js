...
*/
var dinosaurs = [
  { name: "tyrannosoarus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous", roar: "RAWERSRARARWERSARARARRRR!" },
...
console.log(dinosaurs[1].diet);

// How long was a stegosaurus?
console.log(dinosaurs[2].length);
...
Log the result of your new array. */
  ...
  const contactInfo = [];
  graduates.forEach(function(element, index){
...
lowCaseAnimalNames = zooAnimals.map(item => { 
...
lowPopulationAnimals = zooAnimals.filter(e => {
